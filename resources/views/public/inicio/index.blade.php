...
<head>
    ...
    <title>Mediax - Health & Medical HTML Template - Medical Clinic</title>
                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            ...
                            <a href="#"><img src="public/img/product/product_thumb_1_1.jpg" alt="Cart Image">Surgery Hands Gloves</a>
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="public/img/product/product_thumb_1_2.jpg" alt="Cart Image">D-Ribose Drug Medicine</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="public/img/product/product_thumb_1_3.jpg" alt="Cart Image">CAD Dentistry Prosthesis</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="public/img/product/product_thumb_1_4.jpg" alt="Cart Image">Surgery Safety Mask</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="public/img/product/product_thumb_1_5.jpg" alt="Cart Image">Infrared Thermometers</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount">
            ...
            <div class="widget  ">
                <div class="th-widget-about">
                    <div class="about-logo">
                        <a href="home-medical-clinic.html"><img src="public/img/logo.svg" alt="Mediax"></a>
                    </div>
                ...
                <div class="newsletter-widget">
                    ...
                    <div class="btn-group">
                        <a href="https://play.google.com/" class="img-btn">
                            <img src="public/img/normal/apple_store.png" alt="icon">
                        </a>
                        <a href="https://play.google.com/" class="img-btn">
                            <img src="public/img/normal/play_store.png" alt="icon">
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <ul>
                                <li class="d-none d-md-inline-block">
                                    <div class="dropdown-link">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink1" data-bs-toggle="dropdown" aria-expanded="true"><img src="public/img/icon/english.png" alt="icon"> English</a>
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo">
                                <div class="logo-bg" data-bg-src="public/img/bg/logo_bg_1.png"></div>
                                <a href="home-medical-clinic.html"><img src="public/img/logo.svg" alt="Mediax"></a>
                            </div>
                        </div>
...
Hero Area
==============================-->
    <div class="th-hero-wrapper hero-2" id="hero" data-bg-src="public/img/hero/hero_bg_2_1.jpg">
        <div class="hero-inner">
            <div class="container">
                <div class="hero-style2">
                    <span class="sub-title"><img src="public/img/theme-img/title_icon.svg" alt="shape">24/7 Emergency Service</span>
            ...
            <div class="hero-img">
                <img src="public/img/hero/hero_2_1.png" alt="Image">
            </div>
            <div class="hero-shape1">
                <img src="public/img/hero/hero_shape_2_1.svg" alt="shape">
            </div>
            <div class="hero-shape2">
                <img src="public/img/hero/hero_shape_2_2.svg" alt="shape">
            </div>
            <div class="hero-shape3">
                <img src="public/img/hero/hero_shape_2_3.svg" alt="shape">
            </div>
            <div class="hero-shape4">
                <img src="public/img/hero/hero_shape_2_4.svg" alt="shape">
            </div>
            <div class="hero-shape5">
                <img src="public/img/hero/hero_shape_2_5.svg" alt="shape">
            </div>
        </div>
    </div>
    <!--======== / Hero Section ========-->
...
==============================-->
    <div class="space" id="about-sec">
        <div class="shape-mockup" data-top="0" data-right="0"><img src="public/img/shape/pattern_shape_1.png" alt="shape"></div>
        <div class="shape-mockup jump" data-bottom="10%" data-right="3%"><img src="public/img/shape/medicine_1.png" alt="shape"></div>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 mb-30 mb-xl-0">
                    <div class="img-box1">
                        <div class="img1">
                            <img src="public/img/normal/about_1_3.png" alt="About">
                        </div>
                ...
                <div class="col-xl-6">
                    <div class="ps-xxl-4 ms-xl-2 text-center text-xl-start">
                        <div class="title-area mb-32">
                            <span class="sub-title"><img src="public/img/theme-img/title_icon.svg" alt="shape">About Us Company</span>
...
Service Area  
==============================-->
    <section class="overflow-hidden bg-smoke space" id="service-sec" data-bg-src="public/img/bg/service_bg_1.png">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8">
                    <div class="title-area text-center">
                        <span class="sub-title"><img src="public/img/theme-img/title_icon.svg" alt="Icon">Our Services</span>
            ...
            <div class="row gy-4 justify-content-center">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="service-card" data-bg-src="public/img/service/service_card_1.jpg">
                        <div class="box-shape">
                            <img src="public/img/bg/service_card_bg.png" alt="Service">
                        </div>
                        <div class="box-icon">
                            <img src="public/img/icon/service_card_1.svg" alt="Icon">
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="service-card" data-bg-src="public/img/service/service_card_2.jpg">
                        <div class="box-shape">
                            <img src="public/img/bg/service_card_bg.png" alt="Service">
                        </div>
                        <div class="box-icon">
                            <img src="public/img/icon/service_card_2.svg" alt="Icon">
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="service-card" data-bg-src="public/img/service/service_card_3.jpg">
                        <div class="box-shape">
                            <img src="public/img/bg/service_card_bg.png" alt="Service">
                        </div>
                        <div class="box-icon">
                            <img src="public/img/icon/service_card_3.svg" alt="Icon">
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="service-card" data-bg-src="public/img/service/service_card_4.jpg">
                        <div class="box-shape">
                            <img src="public/img/bg/service_card_bg.png" alt="Service">
                        </div>
                        <div class="box-icon">
                            <img src="public/img/icon/service_card_4.svg" alt="Icon">
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="service-card" data-bg-src="public/img/service/service_card_5.jpg">
                        <div class="box-shape">
                            <img src="public/img/bg/service_card_bg.png" alt="Service">
                        </div>
                        <div class="box-icon">
                            <img src="public/img/icon/service_card_5.svg" alt="Icon">
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="service-card" data-bg-src="public/img/service/service_card_6.jpg">
                        <div class="box-shape">
                            <img src="public/img/bg/service_card_bg.png" alt="Service">
                        </div>
                        <div class="box-icon">
                            <img src="public/img/icon/service_card_6.svg" alt="Icon">
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="service-card" data-bg-src="public/img/service/service_card_7.jpg">
                        <div class="box-shape">
                            <img src="public/img/bg/service_card_bg.png" alt="Service">
                        </div>
                        <div class="box-icon">
                            <img src="public/img/icon/service_card_7.svg" alt="Icon">
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="service-card" data-bg-src="public/img/service/service_card_8.jpg">
                        <div class="box-shape">
                            <img src="public/img/bg/service_card_bg.png" alt="Service">
                        </div>
                        <div class="box-icon">
                            <img src="public/img/icon/service_card_8.svg" alt="Icon">
                        </div>
...
Cta Area  
==============================-->
    <section class="overflow-hidden cta-sec4" data-bg-src="public/img/bg/cta_bg_4.jpg">
        <div class="container z-index-common">
            <div class="row align-items-end justify-content-center text-center text-xl-start">
                ...
                <div class="col-xl-5">
                    <div class="img-box2">
                        <img src="public/img/normal/cta_1.png" alt="image">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-6 text-center text-xl-start">
                    <div class="pe-xxl-5 mb-40 mb-xl-0">
                        <div class="title-area mb-32">
                            <span class="sub-title"><img src="public/img/theme-img/title_icon.svg" alt="shape">Why Choose Us</span>
                ...
                <div class="col-xl-6">
                    <div class="img-box3">
                        <img src="public/img/normal/why_1.jpg" alt="Why">
                    </div>
                </div>
            </div>
        </div>
...
Team Area  
==============================-->
    <section class="bg-top-center space-top" id="team-sec" data-bg-src="public/img/bg/team_bg_1.jpg">
        <div class="container z-index-common">
            <div class="title-area text-center">
                <span class="sub-title"><img src="public/img/theme-img/title_icon.svg" alt="Icon">Expert doctors</span>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            <div class="box-img">
                                <img src="public/img/team/team_1_1.jpg" alt="Team">
                                <div class="th-social">
                    ...
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            <div class="box-img">
                                <img src="public/img/team/team_1_2.jpg" alt="Team">
                                <div class="th-social">
                                    <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                                    <a target="_blank" href="https://linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
                                    <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            <div class="box-img">
                                <img src="public/img/team/team_1_3.jpg" alt="Team">
                                <div class="th-social">
                                    <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                                    <a target="_blank" href="https://linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
                                    <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            <div class="box-img">
                                <img src="public/img/team/team_1_4.jpg" alt="Team">
                                <div class="th-social">
                                    <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                                    <a target="_blank" href="https://linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
                                    <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            <div class="box-img">
                                <img src="public/img/team/team_1_5.jpg" alt="Team">
                                <div class="th-social">
                                    <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                                    <a target="_blank" href="https://linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
                                    <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            <div class="box-img">
                                <img src="public/img/team/team_1_6.jpg" alt="Team">
                                <div class="th-social">
                                    <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                                    <a target="_blank" href="https://linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
                                    <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            <div class="box-img">
                                <img src="public/img/team/team_1_7.jpg" alt="Team">
                                <div class="th-social">
                                    <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                                    <a target="_blank" href="https://linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
                                    <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            <div class="box-img">
                                <img src="public/img/team/team_1_8.jpg" alt="Team">
                                <div class="th-social">
                                    <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                                    <a target="_blank" href="https://linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
                                    <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
        ...
        <div class="container">
            <div class="appointment-row">
                ...
                <div class="form-wrap">
                    <div class="img-box4">
                        <div class="img1">
                            <img src="public/img/normal/form_1_1.jpg" alt="Image">
                        </div>
                        <div class="img2">
                            <img src="public/img/normal/form_1_2.jpg" alt="Image">
                        </div>
                    </div>
...
Process Area  
==============================-->
    <section class="space" data-bg-src="public/img/bg/process_bg_1.jpg">
        <div class="container">
            <div class="title-area text-center">
                <span class="sub-title"><img src="public/img/theme-img/title_icon.svg" alt="Icon">Work Process</span>
            ...
            <div class="process-card-wrap">
                <div class="process-card">
                    <div class="box-img">
                        <div class="img">
                            <img src="public/img/normal/process_card_1.jpg" alt="icon">
                        </div>
                ...
                <div class="process-card">
                    <div class="box-img">
                        <div class="img">
                            <img src="public/img/normal/process_card_2.jpg" alt="icon">
                        </div>
                ...
                <div class="process-card">
                    <div class="box-img">
                        <div class="img">
                            <img src="public/img/normal/process_card_3.jpg" alt="icon">
                        </div>
                ...
                <div class="process-card">
                    <div class="box-img">
                        <div class="img">
                            <img src="public/img/normal/process_card_4.jpg" alt="icon">
                        </div>
...
Faq Area
==============================-->
    <div class="overflow-hidden" id="faq-sec" data-bg-src="public/img/bg/faq_bg_1.jpg">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 text-center text-xl-start align-self-center">
                    <div class="pe-xl-4 space-top pt-xl-0 pb-40 pb-xl-0">
                        <div class="title-area text-center text-xl-start">
                            <span class="sub-title"><img src="public/img/theme-img/title_icon_2.svg" alt="Icon">Faqs</span>
                ...
                <div class="col-xl-6">
                    <div class="ps-xxl-4">
                        <div class="faq-img1">
                            <img src="public/img/normal/faq_1.png" alt="faq">
                        </div>
                    </div>
                </div>
            </div>
...
==============================-->
    <section class="space" id="testi-sec">
        <div class="container">
            <div class="title-area text-center">
                <span class="sub-title"><img src="public/img/theme-img/title_icon.svg" alt="shape">Testimonials</span>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="testi-card bg-smoke">
                            ...
                            <div class="box-quote">
                                <img src="public/img/icon/quote_1.svg" alt="Icon">
                            </div>
                            ...
                            <div class="box-profile">
                                <div class="box-img">
                                    <img src="public/img/testimonial/testi_1_1.jpg" alt="Avater">
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testi-card bg-smoke">
                            ...
                            <div class="box-profile">
                                <div class="box-img">
                                    <img src="public/img/testimonial/testi_1_2.jpg" alt="Avater">
                                </div>
                                <div class="box-content">
...
Blog Area  
==============================-->
    <section class="space" id="blog-sec" data-bg-src="public/img/bg/blog_bg_1.jpg">
        <div class="container">
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                <div class="col-lg">
                    <div class="title-area text-center text-lg-start">
                        <span class="sub-title"><img src="public/img/theme-img/title_icon.svg" alt="shape">Our Blog</span>
                ...
                <div class="swiper th-slider has-shadow" id="blogSlider1" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-img">
                                    <img src="public/img/blog/blog_1_1.jpg" alt="blog image">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-img">
                                    <img src="public/img/blog/blog_1_2.jpg" alt="blog image">
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
                                        <a href="blog.html"><i class="fal fa-user"></i>By Mediax</a>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-img">
                                    <img src="public/img/blog/blog_1_3.jpg" alt="blog image">
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
                                        <a href="blog.html"><i class="fal fa-user"></i>By Mediax</a>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card">
                                <div class="blog-img">
                                    <img src="public/img/blog/blog_1_4.jpg" alt="blog image">
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
                                        <a href="blog.html"><i class="fal fa-user"></i>By Mediax</a>
	...
	Footer Area
==============================-->
    <footer class="footer-wrapper footer-layout1" data-bg-src="public/img/bg/footer_bg_1.jpg">
        <div class="container z-index-common">
                ...
                <div class="row justify-content-between">
                    <div class="col-md-6 col-xl-auto">
                        <div class="widget footer-widget">
                            <div class="th-widget-about">
                                <div class="about-logo">
                                    <a href="home-medical-clinic.html"><img src="public/img/logo-footer.svg" alt="Mediax"></a>
                                </div>
                                <p class="about-text">Subscribe to out newsletter today to receive latest news administrate cost effective for tactical data.</p>
                                <p class="footer-info">
                                    <i class="fal fa-location-dot"></i>
                        ...
                        <div class="widget footer-widget">
                            ...
                            <div class="recent-post-wrap">
                                <div class="recent-post">
                                    <div class="media-img">
                                        <a href="blog-details.html"><img src="public/img/blog/recent-post-2-1.jpg" alt="Blog Image"></a>
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="recent-post">
                                    <div class="media-img">
                                        <a href="blog-details.html"><img src="public/img/blog/recent-post-2-2.jpg" alt="Blog Image"></a>
                                    </div>
                                    <div class="media-body">
...
============================== -->
    ...
    <!-- datetimepicker -->
    <script src="public/js/jquery.datetimepicker.min.js"></script>
    <!-- Range Slider -->
